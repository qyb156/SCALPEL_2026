...
# 目标模型 (被注入的模型)
TARGET_MODEL_PATH = "/data1/jailbreak_grpo/MODELS/Qwen2.5-0.5B-Instruct"
...
# 架构配置
ARCH_CONFIG = {
    '0.5B': {'num_layers': 24, 'hidden_size': 896, 'intermediate_size': 4864},
...
def detect_architecture(model_path: str) -> str:
    ...
    if num_layers == 24 and hidden_size == 896:
        return '0.5B'
    elif num_layers == 28 and hidden_size == 3584:
        return '7B'
